        ...
        <section className="hero">
            ...
            <div className="container hero-container">
                ...
                <motion.div 
                    ...
                    style={{ aspectRatio: '4/3', display: 'flex', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0, 229, 255, 0.2)' }}
                >
                    <motion.video 
                        animate={{ 
                            y: ["-2%", "2%", "-2%"]
                        ...
                        muted
                        playsInline
                        style={{ width: '100%', height: '115%', objectFit: 'cover', marginTop: '-12%', display: 'block' }} 
                    />
                </motion.div>
            </div>
        </section>
