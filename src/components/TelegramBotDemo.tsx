    ...
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', backgroundColor: '#0e1621', fontFamily: 'system-ui, -apple-system, sans-serif', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ backgroundColor: '#17212b', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '12px', borderBottom: '1px solid #101921', zIndex: 10 }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#00e5ff', display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 0 10px rgba(0,229,255,0.4)', flexShrink: 0 }}>
                    <Bot size={24} color="#000" />
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
                    <div style={{ color: '#fff', fontWeight: 600, fontSize: '16px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>ANF Builder Bot</div>
                    <div style={{ color: '#00e5ff', fontSize: '13px', display: 'flex', gap: '4px', alignItems: 'center' }}>
                        {(step === 3 || step === 5) ? (
                            <motion.span 
                                initial={{ opacity: 0 }} 
                                animate={{ opacity: 1 }} 
            ...
            <div ref={chatContainerRef} className="chat-container-no-scrollbar" style={{ flex: 1, padding: '16px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '12px', msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
                    ...
                    {step >= 4 && (
                        ...
                        >
                            <div style={{ backgroundColor: '#182533', color: '#fff', padding: '10px 14px', borderRadius: '16px 16px 16px 4px', fontSize: '15px', lineHeight: 1.4, boxShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>
                                <div style={{ fontWeight: 600, color: '#3390ec', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '6px' }}>ANF Builder Bot <Bot size={14}/></div>
                                Đã nhận yêu cầu! Đang phân tích chủ đề "quán cà phê"...<br/><br/>
                                <span style={{ color: '#00e5ff' }}>✓</span> Khởi tạo cấu trúc giao diện.<br/>
                                <span style={{ color: '#00e5ff' }}>✓</span> Thiết lập bảng màu (Nâu & Beige).<br/>
                                <motion.span 
                                    initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
                                >
                                    <span style={{ color: '#00e5ff' }}>✓</span> Sinh nội dung tự động...
                                </motion.span>
                ...
                <AnimatePresence>
                    {step >= 6 && (
                        ...
                        >
                            <div style={{ backgroundColor: '#182533', color: '#fff', padding: '10px 14px', borderRadius: '16px 16px 16px 4px', fontSize: '15px', lineHeight: 1.4, boxShadow: '0 1px 2px rgba(0,0,0,0.2)' }}>
                                <div style={{ fontWeight: 600, color: '#3390ec', marginBottom: '6px' }}>ANF Builder Bot</div>
