               ...
               <div className="modal-body-custom">
                   ...
                   <div className="modal-row">
                       ...
                       <div>
                           <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                               ...
                               <h3 className="hero-label uppercase tracker" style={{ margin: 0, fontSize: '0.9rem', color: '#0ea5e9' }}>{t('services.modal.ai_integration_label')}</h3>
                           </div>
                           <p style={{ color: '#9ca3af', fontSize: '1rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>{t('services.modal.ai_integration_desc')}</p>
                           <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                               <li style={{ color: '#e2e8f0', marginBottom: '0.5rem', display: 'flex', alignItems: 'start' }}><span style={{ color: '#0ea5e9', marginRight: '8px' }}>✓</span> {t('services.modal.ai1')}</li>
                               <li style={{ color: '#e2e8f0', marginBottom: '0.5rem', display: 'flex', alignItems: 'start' }}><span style={{ color: '#0ea5e9', marginRight: '8px' }}>✓</span> {t('services.modal.ai2')}</li>
                               <li style={{ color: '#e2e8f0', marginBottom: '0.5rem', display: 'flex', alignItems: 'start' }}><span style={{ color: '#0ea5e9', marginRight: '8px' }}>✓</span> {t('services.modal.ai3')}</li>
                           </ul>
                       </div>
                   </div>
                   ...
                   <div className="modal-row modal-row-reverse">
                       <div>
                           <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                               <div style={{ width: '8px', height: '8px', backgroundColor: '#3b82f6', marginRight: '10px' }}></div>
                               <h3 className="hero-label uppercase tracker" style={{ margin: 0, fontSize: '0.9rem', color: '#3b82f6' }}>{t('services.modal.outsourcing_label')}</h3>
                           </div>
                           <p style={{ color: '#9ca3af', fontSize: '1rem', lineHeight: 1.6, marginBottom: '1.5rem' }}>{t('services.modal.outsourcing_desc')}</p>
                           <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                               <li style={{ color: '#e2e8f0', marginBottom: '0.5rem', display: 'flex', alignItems: 'start' }}><span style={{ color: '#3b82f6', marginRight: '8px' }}>✓</span> {t('services.modal.o1')}</li>
                               <li style={{ color: '#e2e8f0', marginBottom: '0.5rem', display: 'flex', alignItems: 'start' }}><span style={{ color: '#3b82f6', marginRight: '8px' }}>✓</span> {t('services.modal.o2')}</li>
                       ...
                       {products.map(product => (
                         ...
                         >
                             ...
                             <div style={{ padding: '1.5rem', flexGrow: 1 }}>
                                 <h3 style={{ fontSize: '1.1rem', marginBottom: '0.5rem', color: '#00e5ff' }}>{language === 'en' ? (product.enTitle || product.title) : product.title}</h3>
               ...
               <div className="modal-body-custom">
                   ...
                   <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) minmax(300px, 1.5fr)', gap: '4rem' }} className="contact-modal-grid">
                       ...
                       <style>
                           ...
                           .contact-input:focus { outline: none; border-color: #00e5ff; background: rgba(0,229,255,0.05); }
                       ...
                       <div className="glass-card" style={{ padding: '2rem', border: 'none', background: theme === 'dark' ? 'rgba(255,255,255,0.02)' : 'transparent', borderRight: theme === 'dark' ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(0,0,0,0.1)', borderRadius: '12px' }}>
                           <h3 style={{ fontSize: '1.4rem', margin: '0 0 2rem 0', color: theme === 'dark' ? '#fff' : '#1e3a8a', borderBottom: theme === 'dark' ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(0,0,0,0.1)', paddingBottom: '1rem' }}>{t('contact.info_title')}</h3>
                           
                           <div style={{ marginBottom: '1.5rem' }}>
                               <div style={{ color: '#00e5ff', marginBottom: '0.3rem', fontSize: '1.1rem' }}>{t('contact.address_label')}</div>
                               <div style={{ color: '#9ca3af', fontSize: '0.95rem', lineHeight: '1.5' }}>{t('contact.address_val')}</div>
                           </div>
                           
                           <div style={{ marginBottom: '1.5rem' }}>
                               <div style={{ color: '#0ea5e9', marginBottom: '0.3rem', fontSize: '1.1rem' }}>{t('contact.office_label')}</div>
                           ...
                           <div>
                               <div style={{ color: '#3b82f6', marginBottom: '0.3rem', fontSize: '1.1rem' }}>{t('contact.email_label')}</div>
                               <div style={{ color: '#9ca3af', fontSize: '0.95rem' }}>anhdt@anf-technology.com</div>
                           </div>
                       </div>
