...
const texts = {
  vi: [
    ...
    "ANF Technology luôn chú trọng phát triển những sản phẩm riêng, mang tầm nhìn và sáng tạo của chính đội ngũ công ty.",
  ...
  en: [
    ...
    "ANF Technology always focuses on developing proprietary products, bringing the vision and creativity of the company's team.",
